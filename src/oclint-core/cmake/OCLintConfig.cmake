...
IF (NOT OCLINT_ROOT_DIR)
    SET(OCLINT_ROOT_DIR "${CMAKE_SOURCE_DIR}/..")
ENDIF()
IF (NOT OCLINT_SOURCE_DIR)
    SET(OCLINT_SOURCE_DIR "${OCLINT_ROOT_DIR}/oclint-core")
ENDIF()
IF (NOT OCLINT_METRICS_SOURCE_DIR)
    SET(OCLINT_METRICS_SOURCE_DIR "${OCLINT_ROOT_DIR}/oclint-metrics")
ENDIF()
IF (NOT OCLINT_BUILD_DIR)
    SET(OCLINT_BUILD_DIR "${OCLINT_ROOT_DIR}/build/oclint-core")
ENDIF()
IF (NOT OCLINT_METRICS_BUILD_DIR)
    SET(OCLINT_METRICS_BUILD_DIR "${OCLINT_ROOT_DIR}/build/oclint-metrics")
ENDIF()
...
IF(LLVM_ROOT)
    ...
    INCLUDE(LLVMConfig)
ELSE()
    FIND_PACKAGE(LLVM REQUIRED CONFIG PATHS "${OCLINT_ROOT_DIR}/build/llvm-install")
ENDIF()
